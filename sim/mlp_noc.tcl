...
set output_file_path $QSYS_SIMDIR/test_files/mlp/output.out
set output_file "./test_files/mlp/results.txt"
...
# exec python3 test_files/mlp/create_stimulus.py
# exec python3 test_files/mlp/golden_out.py
# exec python3 test_files/mlp/create_stimulus_signed.py
# exec python3 test_files/mlp/golden_out_signed.py
...
# set wave_file "./test_files/mlp/wave.do"
# set python_file "./test_files/mlp/generate_wave.py"
